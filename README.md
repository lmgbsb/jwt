...
Por convenção, o token JWT é enviado no header **Authorization** do cabeçalho HTTP com o prefixo "Bearer"

![](./src/main/resources/static/img/token_jwt_cabecalho_http_7.png)
...
![](./src/main/resources/static/img/jwt_decoded_7.png)
